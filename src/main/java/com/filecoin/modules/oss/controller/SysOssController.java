...
import com.filecoin.common.validator.group.AliyunGroup;
import com.filecoin.common.validator.group.QcloudGroup;
import com.filecoin.common.validator.group.QiniuGroup;
import com.filecoin.modules.oss.cloud.CloudStorageConfig;
import com.filecoin.modules.oss.cloud.OSSFactory;
...
public class SysOssController {
	...
	public JsonResult upload(@RequestParam("file") MultipartFile file) throws Exception {
		if (file.isEmpty()) {
			throw new FileCoinException("上传文件不能为空");
		}
		...
		return JsonResult.ok().put("url", url);
	}

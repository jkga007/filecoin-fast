...
import com.filecoin.modules.sys.service.SysRoleMenuService;
import com.filecoin.modules.sys.dao.SysRoleDao;
import com.filecoin.modules.sys.entity.SysRoleEntity;
...
public class SysRoleServiceImpl implements SysRoleService {
	...
	private void checkPrems(SysRoleEntity role){
		...
		if(!menuIdList.containsAll(role.getMenuIdList())){
			throw new FileCoinException("新增角色的权限，已超出你的权限范围");
		}
	}
}

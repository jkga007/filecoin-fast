...
import com.filecoin.modules.sys.dao.SysUserTokenDao;
import com.filecoin.modules.sys.entity.SysUserTokenEntity;
import com.filecoin.modules.sys.oauth2.TokenGenerator;
...
public class SysUserTokenServiceImpl implements SysUserTokenService {
	...
	@Override
	public JsonResult createToken(long userId) {
		//生成一个token
		...
		JsonResult jsonResult = JsonResult.ok().put("token", token).put("expire", EXPIRE);
